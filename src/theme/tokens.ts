/**
 * Velness Design System — Unified Design Tokens
 *
...
/**
 * Shadows use a LAVENDER TINT (never pure black) to match the companion
...
export const gradients = {
  /** Primary brand gradient: deeper lavender → soft lavender (decorative). */
  primary: ['#A878E0', '#CD9CF2'] as const,
  brandDeep: ['#8A5FC7', '#A878E0'] as const,
  purple: ['#9A78D0', '#C9A8F0'] as const,
  cyan: ['#06B6D4', '#22D3EE'] as const,
  warm: ['#A878E0', '#F4A6C9'] as const,
  calm: ['#7CC0E0', '#CD9CF2'] as const,
} as const;
...
export const chat = {
  ...
  blocks: {
    /** Accent colors per block type — derived from the lavender mood ramp. */
    reflection: '#9A78D0',
    question: '#CD9CF2',
    action: '#4FAE8B',
    summary: '#E0A93B',
